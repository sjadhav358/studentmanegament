...
<!--creating navbar -->
 ...
 <div class="row">
		...
		<div class="tab-content p-2" id="one"><!--tab content--start-->
		   ...
		   <!--student-->
 		    <div class="tab-pane show fade" id="student"><!--student tab-pane started-->
	         ...
	         $q=  "select userid from student where name= 'sachin' ";
  		    ...
  		    <div class="  studentform">
		       <form action="backend.php" method="POST">
		       	...
		       	<div class="form-group inline-div">
		       		<label>Name</label>
		       		<input type="text" class="form-control" name="name" id="user_id"
		       		value="<?php echo $name;?>">
		       	</div>
		       	...
		       	<div class="form-group inline-div">
		       		...
		       		<input type="text" class="form-control" name="password" id="password_id">
		       	</div>
		       	<br>
		       	<br>
		       	<input type="submit" class="btn btn-success ml-5" value="save" name="submit"/>
